...
Предположительно можно добавить данные - курс доллара, погодные условия, knn до [1, n] соседям, расстояние от условного центра города или каким-либо другим образом оцененное местоположение, скользящее среднее, день недели
...
Население, средння зп в городе, изменение температуры по сравнению с предыдущим днем, отклонение температуры от от среднего за несколько предыдущих лет, бинарный признак-праздник в текущий день
...
Добавить признаки - дней с начала года, давление атмосферы
